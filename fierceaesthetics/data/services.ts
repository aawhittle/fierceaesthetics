...
lashBrow: {
  ...
  intro: [ `
    Beautifully defined lashes and brows can completely transform your look.
    
    Our professional lash and brow treatments are designed to enhance your natural features, creating fuller, lifted, and perfectly groomed results with minimal daily maintenance.
  ...
  items: [
    {
      ...
      price: "£45",
      description: `
        A classic treatment designed to enhance the natural beauty of your lashes.
        ...
        },
    {
      ...
      price: "£50",
      description: `
        An advanced lash lift technique known for producing a softer, more natural-looking curl while maintaining optimal lash health.
        
        Using nourishing and conditioning formulas, this treatment lifts the lashes while keeping them glossy, flexible, and beautifully defined.
 ...
 bodyContouring: {
  ...
  items: [
    {
      ...
      description: `
        ...
        This treatment works by breaking down fat cells while stimulating collagen production to tighten and smooth the skin.
        
        Lymphatic drainage massage is included to support the body’s natural detoxification process.
   ...
   `
        },
    {
      ...
      description: `
        ...
        Using advanced radio frequency technology, this treatment gently heats the deeper layers of the skin to stimulate collagen and elastin production.
    ...
    },
    {
      ...
      description: `
        ...
        This treatment helps improve skin laxity while enhancing shape and contour.
        
        Lymphatic drainage massage helps boost circulation and support the body’s natural detoxification process.
    `
        },
    {
      ...
      description: `
        ...
        This treatment begins with a full professional facial using the premium Million Dollar skincare range, including deep cleansing, exfoliation and targeted products chosen to suit your skin type.
        
        Radio frequency technology is then used to gently heat the deeper layers of the skin, stimulating collagen and elastin production to improve firmness and elasticity.
  ...
  items: [
    {
      name: "Million Dollar Dermaplaning",
      time: "45 mins",
      price: "£49",
      description: `
        This manual exfoliation treatment gently removes the outermost layers of dead skin cells and fine vellus hair (“peach fuzz”) using a sterile surgical blade, alongside the professional Million Dollar skincare range.
        
        Dermaplaning enhances the absorption of skincare products, diminishes the appearance of fine lines and wrinkles, stimulates collagen production, and promotes a healthy, radiant complexion.
        
        Skin is left smooth, fresh, and glowing.

        The 45-minute treatment includes a lymphatic drainage massage and a luxurious mask.
    `
        },
    {
        ...
        },
    {
      ...
      price: "£89",
      description: `
        Million Dollar Body treatments are designed to target areas of concern from the neck down.
        
        Using the science of microneedling alongside clinically proven products, this treatment helps improve the appearance of stretch marks, cellulite, and scarring.
