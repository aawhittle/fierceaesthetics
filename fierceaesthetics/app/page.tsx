...
{/* Floating icon buttons (auto-hide near footer) */} <div className={fixed bottom-6 right-6 z-50 flex flex-col gap-3 transition-all duration-300 ${ hideSocial ? "opacity-0 translate-y-3 pointer-events-none" : "opacity-100" }} > <a href="https://instagram.com/fierceaestheticsuk?igsh=a284azI3azJkd2N2" target="_blank" rel="noreferrer" aria-label="Instagram" className="h-12 w-12 grid place-items-center rounded-full bg-white/70 backdrop-blur-md border border-[rgba(var(--gold),0.25)] text-[rgb(var(--gold))] shadow-[0_18px_50px_rgba(0,0,0,0.12)] hover:bg-white/85 transition" > <InstagramIcon className="h-5 w-5 text-[rgb(var(--gold))]" /> </a> <a href="https://wa.me/447900783177?text=Hi%20I%E2%80%99d%20like%20to%20book%20an%20appointment" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="h-12 w-12 grid place-items-center rounded-full bg-white/70 backdrop-blur-md border border-[rgba(var(--gold),0.25)] text-[rgb(var(--gold))] shadow-[0_18px_50px_rgba(0,0,0,0.12)] hover:bg-white/85 transition" > <WhatsAppIcon className="h-5 w-5 text-[rgb(var(--gold))]" /> </a> <a href="http://www.tiktok.com/@fierceaestheticsuk" target="_blank" rel="noreferrer" aria-label="TikTok" className="h-12 w-12 grid place-items-center rounded-full bg-white/70 backdrop-blur-md border border-black/10 shadow-[0_18px_50px_rgba(0,0,0,0.12)] hover:bg-white/85 transition" > <TikTokIcon className="h-5 w-5 text-[rgb(var(--gold))]" /> </a> <a href="https://www.facebook.com/fierceaestheticschorley/" target="_blank" rel="noreferrer" aria-label="Facebook" className="h-12 w-12 grid place-items-center rounded-full bg-white/70 backdrop-blur-md border border-black/10 shadow-[0_18px_50px_rgba(0,0,0,0.12)] hover:bg-white/85 transition" > <FacebookIcon className="h-5 w-5 text-[rgb(var(--gold))]" /> </a> </div>
    </main>
  );
}